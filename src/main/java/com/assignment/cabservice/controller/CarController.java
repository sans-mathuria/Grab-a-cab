...
public class CarController {
    ...
    @RequestMapping("list-rent-cars")
    public String listCarsWithoutDriver(ModelMap modelMap) {
        List<Car> cars=carRepository.findByDriverIdIsNullAndAvailableForBookingTrue();
        modelMap.put("cars",cars);
        return "listRentCars";
    }
    ...
    public String listAllAvailableCarsForBooking(@RequestParam int seatingCapacity,ModelMap modelMap) {
        List<Car> cars=carRepository.findBySeatingCapacityAndAvailableForBookingTrueAndDriverIdIsNotNull(seatingCapacity);
        modelMap.put("cars",cars);
    ...
    public String addNewCar(Car car) throws Exception {
        ...
        carpool.setDriverId(car.getDriverId());
        carpool.setCarCapacity(car.getSeatingCapacity());
        carpool.setIsFull(false);
        carpool.setIsStarted(false);
        carpool.setSeatsLeft(car.getSeatingCapacity());
        car.setAvailableForBooking(true);
        carRepository.save(car);
        carpool.setId(car.getId());
