...
public interface CarRepository extends JpaRepository<Car,Integer> {
    ...
    List<Car> findBySeatingCapacityAndAvailableForBookingTrueAndDriverIdIsNotNull(int seatingCapacity);
    List<Car> findByDriverIdIsNullAndAvailableForBookingTrue();
